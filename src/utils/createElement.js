...
export default function createElemen(id) {
  ...
  <circle cx="6" cy="6" r="6" fill="#FF5F56" stroke="#E0443E" stroke-width=".5" onclick="removeElement('${id}')" style="cursor:pointer"></circle>
  <circle cx="26" cy="6" r="6" fill="#FFBD2E" stroke="#DEA123" stroke-width=".5" onclick="removeElement('${id}')" style="cursor:pointer"></circle>
  <circle cx="46" cy="6" r="6" fill="#27C93F" stroke="#1AAB29" stroke-width=".5" onclick="removeElement('${id}')" style="cursor:pointer"></circle>
  </g>
  </svg>`;
